...
(function($) {
  ...
  $(function() {
    ...
    if ($('.navbar-dropdown .scrollable-container').length) {
      const scrollablecontainer = new PerfectScrollbar('.scrollable-container');
    }
    ...
    // // Sidebar theme settings and setlocalstorage
    // $("input:radio[name=sidebarThemeSettings]").click(function() {
    //   var sidebarTheme = $(this).val();
    //   $('body').removeClass('sidebar-light sidebar-dark').addClass(sidebarTheme);
    //   localStorage.setItem('sidebar-theme', sidebarTheme);
    //  })

    // // // onload function
    // // $(window).on('load', function() {
    // //   //  on page load set sidebar theme from localstorage
    // // var sidebarTheme = localStorage.getItem('sidebar-theme');
    // // if (sidebarTheme) {
    // //   $('body').removeClass('sidebar-light sidebar-dark').addClass(sidebarTheme);
    // //   // add active class to radio button
